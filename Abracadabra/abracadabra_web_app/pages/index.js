    ...
    return (
        ...
        <div className="container-fluid p-0 m-0 h-100 bg">
            ...
            <div className="row h-5 m-0 pt-3">
                <a href="#" className="mx-auto listlink">Click here to see a list of all subjects</a>
            </div>
            <div className="row m-0 h-95">
                <div className="circle_container col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2 col-xs-12 mx-auto p-0">
                    <div className="central_text text-center">
                        <img className="mx-auto my-auto LandingLogo" src={require('../src/images/Abra_Logo_Centered.png?webp')} />
                    </div>

                    <div className="moon_container moon1"><div className="moon moon1 box leftSideTalk" id="BigSubject">Big Subject</div></div>
                    <a href="/topic"><div className="moon_container moon2"><div className="moon moon2 box leftSideTalk" id="VeryBigSubject">Cooking</div></div></a> {/*h2 className='SubjectTitle'></h3> */}
                    ...
                    <div className="moon_container moon8"><div className="moon moon8 box bottomMiddleTalk">Subject</div></div>
                </div>
            </div>
        </div>
    );
