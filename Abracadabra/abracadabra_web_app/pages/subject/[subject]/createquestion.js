...
function QuestionForm() {
  ...
  const handleInputChange = (e) => {
    setQuestion({
      ...
      subjectname: router.query.subject,
    });
  };
  ...
  return (
    <>
      ...
      <Form
        ...
        className="questionForm mx-auto"
      >
        ...
        <Form.Group>
          ...
          <Form.Control
            data-testid="question-input-question"
            required
            className="question createquestion-title"
            type="text"
            name="title"
        ...
        <Form.Group>
          ...
          <Form.Control
            data-testid="question-input-description"
            required
            as="textarea"
            rows="10"
            name="description"
            onChange={handleInputChange}
            placeholder="Expand on Your Question Here"
            minLength="25"
          />
          <Form.Control.Feedback className="feedback">
          ...
          <Form.Control.Feedback type="invalid" className="feedback">
            The Description Needs to be at least 25 Characters long!
          </Form.Control.Feedback>
        </Form.Group>
        <div>
          <Button
            data-testid="question-button-submit"
            className="buttonSubmit float-right"
            type="submit"
          >
            Submit Question
          </Button>
