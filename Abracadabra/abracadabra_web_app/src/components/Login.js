				...
				<div className="main-login main-center">
					...
					<form onSubmit={handleSubmit}>
						<div className="form-group input-group">
        					...
        					<input onChange={handleChange} name="email" className="form-control" placeholder="Email" type="text" required/>
    					</div>
						...
						<div className="form-group input-group">
        					...
        					<input onChange={handleChange} name="password" className="form-control" placeholder="Password" type="text" required/>
    					</div>
